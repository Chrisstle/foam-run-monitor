...
- **Dynamic Caching**: Actively caches metrics like iteration speed and Courant numbers to ensure the UI stays solid and never flickers when polling between sequential solver output updates.
